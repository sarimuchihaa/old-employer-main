...
import { ArrowIcon, ClearIcon, DislikeIcon, GridIcon, LikeIcon, ListIcon, LocationIcon, PlussIcon, SearchIcon } from "../../icon";
                ...
                <div className={styles["columns-container"]}>
                    <div className={styles["left-column"]}>
                        <div className={styles["filter-group"]}>
                            <div className={`${styles["saved-searches-dropdown"]} ${isOpen ? styles["open"] : ''}`}>
                                <div className={styles["header"]} onClick={toggleDropdown}>
                                    <span className={styles["title"]}>Saved Searches</span>
                                    <div className={styles["icons"]}>
                                        <span className={styles["arrow"]} style={{ transform: isOpen ? 'rotate(180deg)' : 'none' }}>
                                            <ArrowIcon />
                                        </span>
                                        <button className={styles["add-button"]}><PlussIcon /></button>
                                    </div>
                                </div>
                                {isOpen && (
