...
import CompanyReviews from "../../components/Search/CompanyReviews";
import JoinWithSocialMedia from "../../components/Search/JoinWithSocialMedia";
  ...
  const handleSearch = async () => {
    ...
    try {
      if (role === "Employee") {
        ...
        console.log(params);
        router.push(
          `/employeeSearch?${new URLSearchParams(params).toString()}`
        );
        ...
        console.log(params);
        router.push(
          `/employerSearch?${new URLSearchParams(params).toString()}`
        );
      ...
      <div className={styles["content-container"]}>
        <div className={styles["header"]}>
          ...
          <p className={`${styles["header-subtitle"]} ${styles["p"]}`}>
            Read reviews and discover great companies!
            <br />
            Write reviews & help others discover the right job & great
            companies.
          </p>
        </div>
